<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:97:"E:\wamp64\www\houtai\mobanadmin\fastadmin\public/../application/common\view\tpl\dispatch_jump.tpl";i:1521604817;}*/ ?>
<!DOCTYPE html>
<html>
    <head>
    ...
    <body>
        <div class="system-message <?php echo $code == 1 ? 'success' : ($code == 0 ? 'error' : 'info');?>">
            <div class="image">
                <img src="/houtai/mobanadmin/fastadmin/public/assets/img/<?php echo $code == 1 ? 'success' : ($code == 0 ? 'error' : 'info');?>.svg" alt="" width="150" />
            </div>
            <h1><?php echo($msg);?></h1>
            <p class="jump">
